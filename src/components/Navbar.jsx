          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 lg:px-0">
            ...
            <div className="hidden items-center gap-8 text-sm font-medium lg:flex">
              ...
              <DesktopDropdown label="Layanan Publik">
                <DropdownButton>Pelayanan Administrasi</DropdownButton>
                <DropdownButton>Pelayanan Kependudukan</DropdownButton>
                <DropdownButton>Pelayanan Umum</DropdownButton>
              </DesktopDropdown>
          ...
          <Disclosure.Panel className="border-t border-white/10 lg:hidden">
            <div className="space-y-1 px-4 pb-4 pt-3 text-sm font-medium">
              ...
              <MobileGroup label="Layanan Publik">
                <MobileSubLink>Pelayanan Administrasi</MobileSubLink>
                <MobileSubLink>Pelayanan Kependudukan</MobileSubLink>
                <MobileSubLink>Pelayanan Umum</MobileSubLink>
              </MobileGroup>

              <MobileGroup label="Informasi">
                <MobileSubLink to="/berita">Berita Kelurahan</MobileSubLink>
...
function MobileLink({ to, children }) {
  ...
  // Auto-close menu ketika link diklik
  return (
    <Disclosure.Button
      as={Link}
      to={to}
